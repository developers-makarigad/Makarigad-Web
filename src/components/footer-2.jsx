...
export function FooterWithSocialLinks() {
  return (
    <footer className="w-full bg-white border-t-4 rounded-3xl border-gray-200 font-[Poppins]">
      ...
      {/*   Main Grid */}
        ...
        <div className="mt-10 border-t border-gray-200 pt-4 text-center text-sm text-gray-500">
          &copy; {currentYear} Makari Gad Hydro Power. All Rights Reserved.
        </div>
